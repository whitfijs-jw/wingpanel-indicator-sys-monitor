...
public class SysMonitor.Widgets.SettingsView : Gtk.Grid {
    ...
    construct {
        ...
        settings.schema.bind ("show-ram", show_ram_switch.get_switch (),
                              "active", SettingsBindFlags.DEFAULT);
        settings.schema.bind ("show-cpu", show_cpu_switch.get_switch (),
                              "active", SettingsBindFlags.DEFAULT);
        settings.schema.bind ("show-network", show_network_switch.get_switch (),
                              "active", SettingsBindFlags.DEFAULT);
        settings.schema.bind ("show-desr", show_desr_switch.get_switch (),
                              "active", SettingsBindFlags.DEFAULT);
        settings.schema.bind ("show-graph", show_graph_switch.get_switch (),
                              "active", SettingsBindFlags.DEFAULT);
        settings.schema.bind ("show-icon", show_icon_switch.get_switch (),
                              "active", SettingsBindFlags.DEFAULT);
        settings.schema.bind ("network-in-bits", network_in_bits_switch.get_switch (),
                              "active", SettingsBindFlags.DEFAULT);
        settings.schema.bind ("show-cpu-temp", show_cpu_temp_switch.get_switch (),
                              "active", SettingsBindFlags.DEFAULT);
